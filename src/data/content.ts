export const churchContent = {
  ...
  ourCongregation: {
    ...
    vicarLabel: "Rev. Mekkattil M.C. Kuriakose Ramban",
    mission: "The congregation was established to provide spiritual services to students arriving to study on Vancouver Island, and to serve the Orthodox faithful living in Victoria.",
  },
  leadership: [
    {
      role: "The Supreme Head",
      name: "H.H. Baselios Marthoma Mathews III",
      title: "Catholicos of the East and Malankara Metropolitan.",
    },
    {
      role: "Assistant Metropolitan of Canada Diocese",
      name: "Metropolitan Zachariah Mar Nicholovos",
      title: "Metropolitan of the Northeast American Diocese.",
    },
    {
      role: "The Vicar",
      name: "Rev. Mekkattil M.C. Kuriakose Ramban",
      title: "",
    },
  ],
  faith: {
    title: "Malankara Orthodox Syrian Church",
    subtitle: "Faith and Doctrines",
    description: [
  ...
  contact: {
    ...
    trustee: {
      name: "Varughese Koshy",
      phone: "+1 (250) 710-1874",
    },
    secretary: {
      name: "Ashish Philip Cheriyan",
      phone: "+1 (778) 535-3885",
    },
