...
export const metadata: Metadata = {
  title: "St. Peter's & St. Paul's Orthodox Syrian Congregation | Victoria, BC",
  ...
  keywords: ["Syrian Orthodox", "Orthodox Church Victoria", "St. Peter & St. Paul Victoria", "Malankara Orthodox Syrian Church", "Victoria BC Christian Church", "Indian Orthodox Victoria", "Syrian Orthodox Christianity","St. Peter & St. Paul Syrian Church victoria canada","St. Peter & St. Paul Orthodox Syrian Congregation Victoria","stpeterandstpaulorthodoxvictoria"],
  icons: {
    icon: "/logo.jpeg",
    apple: "/logo.jpeg",
  },
